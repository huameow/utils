...
var momentDurationFormatSetup = _interopDefault(require("moment-duration-format"));
...
function checkHasProperty(value, key, items) {
  return items.some(R.pathEq(key, value));
}
var checkHasProperty$1 = R.curry(checkHasProperty);

exports.b64toBlob = b64toBlob;
exports.checkHasProperty = checkHasProperty$1;
exports.copy = copy;
...
exports.nonRounding = nonRounding;
exports.priceFormat = priceFormat;
exports.randomString = randomString;
exports.rounding = rounding;
exports.setSpaces = setSpaces;
exports.switchCentAndYuanProps = switchCentAndYuanProps;
