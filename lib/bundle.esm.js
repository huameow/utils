import { is, isNil, isEmpty, repeat, curry, pathEq } from "ramda";
...
function checkHasProperty(value, key, items) {
  return items.some(pathEq(key, value));
}
var checkHasProperty$1 = curry(checkHasProperty);

export {
  b64toBlob,
  checkHasProperty$1 as checkHasProperty,
  copy,
  createObjectURL,
  crypto,
  decodeHTMLEntities,
